		...
		/*	if(bouncer_x2 <= 0 - frameWidth)
         ...
         switch(ev.keyboard.keycode) {
			 ...
			 case ALLEGRO_KEY_UP:
               ...
               put_network_data(sockfd, buffer, KEY_UP, true);		//Mando por red tecla arriba
			 ...
			 case ALLEGRO_KEY_SPACE:
               ...
               put_network_data(sockfd, buffer, KEY_SPACE, true);	//Mando por red tecla arriba
         ...
         switch(ev.keyboard.keycode) {
			 ...
			 case ALLEGRO_KEY_SPACE:
               ...
               put_network_data(sockfd, buffer, KEY_SPACE, false);              
